package com.example.hangman.shared.collection.domain;
...
@UnitTest
class HangmanCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class HangmanCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = HangmanCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = HangmanCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class HangmanCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = HangmanCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = HangmanCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class HangmanCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = HangmanCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = HangmanCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Map")
  class HangmanMapTest {

    @Test
    void shouldGetEmptyImmutableMapFromNullMap() {
      Map<Object, Object> input = null;
      Map<Object, Object> map = HangmanCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = HangmanCollections.immutable(input);
